...
class m150407_105252_create_role_table extends \yii\db\Migration
{
    /**
    ...
    public function up()
    {
        ...
        $role = $authManager->createRole('moder');
        ...
        $authManager->assign($userRole, 1); //adding localhost to admin
    }
